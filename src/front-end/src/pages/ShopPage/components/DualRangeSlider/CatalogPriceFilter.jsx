...
const CatalogPriceFilter = ({ onPriceChange, firstValueMaxPrice }) => {
    const initialMinPrice = 0;
    const initialMaxPrice = firstValueMaxPrice;
    ...
    useEffect(() => {
        if(isDragging === false) {
            onPriceChange({min: minVal, max: maxVal}); // Передача данных в родителя
        }
